...
# Declare candidates votes DICTIONARY (empty)
candidate_votes = {}

# Winning Candidate, Vote Count and Winning Percentage Tracker
winning_candidate = ""
winning_count = 0
...
with open(file_to_load) as election_data:
    ...
    for row in file_reader:
        ...
        if candidate_name not in candidate_options:
            ...
            # Begin tracking current candidate's vote count.
...
with open(file_to_save, "w") as txt_file:
    ...
    # Determine the %age of votes for each candidate by looping through the counts.
